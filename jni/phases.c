/* Cut-n-paste from the kdeplasma-addons-4.10.5 from KDE. */
...
/* convert a Julian Date to a date-time group */
{
  ...
  /*__android_log_print(ANDROID_LOG_DEBUG,"JDtoDate","JDE=%f day= %d month= %d year= %d\n",
		  jd,event_date->tm_mday,event_date->tm_mon,1900+event_date->tm_year);*/
